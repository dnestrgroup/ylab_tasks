...
class TestMenu(TestClientBase):
    ...
    async def test_clear_db(self) -> None:
        """
        чистим бд
        """
    ...
    async def test_get_menu_by_id(self) -> None:
        """
    ...
    @pytest.mark.asyncio  # type: ignore
    async def test_get_menu_not_empty(self) -> None:
        """
    ...
    @pytest.mark.asyncio(depends=['TestMenu::test_post_menu'])  # type: ignore
    async def test_update_menu_by_id(self) -> None:
        """
