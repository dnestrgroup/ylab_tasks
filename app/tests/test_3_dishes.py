...
class TestDishes(TestClientBase):
    ...
    @pytest.mark.asyncio(depends=['TestDishes::test_post_menu', 'TestDishes::test_post_sub_menu'])  # type: ignore
    async def test_get_dishes(self) -> None:
        """
    ...
    @pytest.mark.asyncio  # type: ignore
    async def test_post_dishes(self) -> None:
        """
        создаем блюдо
        """
        dish_title = 'CocaCola'
        ...
        dish_price = 100.5
        data = {'title': dish_title, 'description': dish_description, 'price': dish_price}
    ...
    @pytest.mark.asyncio  # type: ignore
    async def test_get_dishes_not_empty(self) -> None:
        """
    ...
    @pytest.mark.asyncio()  # type: ignore
    async def test_get_dish_by_id(self) -> None:
        """
        просмотр определенного блюда по id
        """
        response = await self.client.get(
            f'/menus/{pytest.id_menu}/submenus/{pytest.id_sub_menu}/dishes/{pytest.id_dish}'
        )
        assert response.status_code == 200
    ...
    @pytest.mark.asyncio(depends=['TestDishes::test_post_menu', 'TestDishes::test_post_sub_menu'])  # type: ignore
    async def test_update_dish_by_id(self) -> None:
        """
        ...
        new_dish_price = 99.5
        data = {'title': new_dish_title, 'description': new_dish_description, 'price': new_dish_price}
        response = await self.client.patch(
            f'/menus/{pytest.id_menu}/submenus/{pytest.id_sub_menu}/dishes/{pytest.id_dish}', json=data
        )
        assert response.status_code == 200
    ...
    @pytest.mark.asyncio(depends=['TestSubMenu::test_post_menu', 'TestDishes::test_post_sub_menu'])  # type: ignore
    async def test_delete_dish_by_id(self) -> None:
        """
    ...
    @pytest.mark.asyncio(depends=['TestMenu::test_post_menu'])  # type: ignore
